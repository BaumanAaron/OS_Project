...
public class Server3 {
    ...
    private static final ArrayList<Integer> connectedServers = new ArrayList<>(Arrays.asList(5001, 5002, 5004, 5005));
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 10; i++) {
            int delay = random.nextInt(1000) + 5000; //sends request every 5-6 seconds
            Thread.sleep(delay);
