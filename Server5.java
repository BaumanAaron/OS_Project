...
public class Server5 {
    ...
    private static final ArrayList<Integer> connectedServers = new ArrayList<>(Arrays.asList(5001, 5002, 5003, 5004));
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(Server5::listen).start();

        // Generate 10 random request and client operations
        for (int i = 0; i < 10; i++) {
            int delay = random.nextInt(1000) + 1000; //sends request every 1-2 seconds
            Thread.sleep(delay);
    ...
    private static void listen() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("Server 5 listening on port " + PORT);
            ...
            System.err.println("Server 5 disconnected");
        }
    }
    ...
    private static void sendResponse(int lampTime, int port, int operation, String client){
        ...
        try (Socket socket = new Socket("localhost", port);
            ...
            System.out.println("Couldn't reach server "+(port-5000));
        }
    }
    ...
    private static void clientNames(){
        clients.put(0, "George");
        clients.put(1, "Bill");
        clients.put(2, "Richard");
        clients.put(3, "Al");
        clients.put(4, "Barack");
        clients.put(5, "Donald");
        clients.put(6, "Brandon");
        clients.put(7, "Teddy");
        clients.put(8, "Franklin");
        clients.put(9, "Abe");
    }
}
