...
public class Server5 {
    private static final int SERVER_ID = 5; // Unique ID for this server
    private static final int PORT = 5005; // Port number for this server
    ...
    public static void main(String[] args) {
        ...
        new Thread(Server5::startServer).start();
