...
public class Server1 {
    ...
    private static final ArrayList<Integer> connectedServers = new ArrayList<>(Arrays.asList(5002, 5003, 5004, 5005));
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(Server1::listen).start();

        // Generate 10 random request and client operations
        for (int i = 0; i < 10; i++) {
            int delay = random.nextInt(1000) + 9000; //sends request every 9-10 seconds
            Thread.sleep(delay);
    ...
    private static void listen() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("Server 1 listening on port " + PORT);
            ...
            System.err.println("Server 1 disconnected");
        }
    }
